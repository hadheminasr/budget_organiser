  ...
  return (
    <div className="w-full flex flex-col gap-4 sm:gap-5">
      ...
      {isGerant && data.lastResetMonth !== new Date().toISOString().slice(0, 7) && (
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-4 py-3.5 rounded-xl bg-[#FAEEDA] border border-[#FAC775]">
          ...
          <button
            ...
            className="w-full sm:w-auto px-3.5 py-2 sm:py-1.5 bg-[#EF9F27] text-white text-xs font-medium rounded-lg hover:bg-[#BA7517] transition-colors"
          >
            Commencer
          </button>
        </div>
